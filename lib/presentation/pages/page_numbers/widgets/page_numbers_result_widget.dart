...
import '../../../../data/models/rotate_result.dart'; // This contains PageNumbersResult

class PageNumbersResultWidget extends StatelessWidget {
  final PageNumbersResult result;

  const PageNumbersResultWidget({
    super.key,
